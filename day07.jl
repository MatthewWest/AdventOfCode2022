...
# ╔═╡ d9d32dec-7637-11ed-0dbc-4546b727dbdc
begin
	input = raw"""$ cd /
$ ls
dir jmtrrrp
...
215479 ffwlcrwb
""";
	md"Real input (cell hidden for readability)"
end

# ╔═╡ f25f6a12-679e-451a-a7db-50aa6b0e45cb
begin
	test_input = raw"""$ cd /
$ ls
dir a
...
5626152 d.ext
7214296 k"""
	md"Test input (cell hidden for readability)"
end

# ╔═╡ 72063f21-9070-46b9-afcb-938e9aa30d8d
struct File
	size::Int
	name::String
...
# ╔═╡ c81748bc-2043-438b-8b56-a8716741d58b
mutable struct Dir
	name::String
	files::Vector{File}
	dirs::Vector{Dir}
...
# ╔═╡ d2ebc270-8b2b-411a-aed2-03af3d16af15
...
# ╔═╡ 86e473b5-a826-4191-963b-237830a22610
...
# ╔═╡ 8ae28dce-b8dd-4e64-ae71-24cdd38c7302
...
# ╔═╡ 6e415be8-9d14-4608-ab74-980f0531e8c6
get_descendant_dirs(get_input(test_input))

# ╔═╡ 71bf9352-8336-46b2-946f-15e4eaae5606
function part1(s = input)
	sizes = get_input(s) |> get_descendant_dirs |> ds -> size.(ds)
	sum(filter(n -> n <= 100000, sizes))
end

# ╔═╡ 438366b9-3897-44c0-b94a-020830036bcf
part1()

# ╔═╡ 537c29c3-2918-400d-aa0d-1d77ed9c233c
...
# ╔═╡ 415ce616-5d6d-41d8-8df9-508e1c7aaeab
part2()
